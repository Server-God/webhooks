        ...
        (function(n) {
            ...
            a.a = function() {
                ...
                var m = {
                  ...
                  , k = s && function() {
                    for (var a = 3, b = s.createElement("div"), c = b.getElementsByTagName("i"); b.innerHTML = "\x3c!--[if gt IE " + ++a + "]><i></i><![endif]--\x3e",
                    c[0]; )
                        ;
                    return 4 < a ? a : n
                }()
            ...
            a.ya.trackArrayChanges = function(b, c) {
                ...
                if (!b.Wb) {
                    ...
                    b.Ia = function(a) {
                        k && k.call(b, a);
                        "arrayChange" !== a || b.Pa("arrayChange") || (l && (b.notifySubscribers = l,
                        l = n),
                        g.k(),
                        e = !1)
                    }
            ...
            a.d.options = {
                ...
                update: function(b, c, d) {
                    ...
                    a.l.w(function() {
                        k ? a.j.ha(b, a.a.c(d.get("value")), !0) : (h ? p.length && e().length < p.length : p.length && 0 <= b.selectedIndex ? a.j.u(b.options[b.selectedIndex]) !== p[0] : p.length || 0 <= b.selectedIndex) && a.a.Da(b, "change")
                    });
                    a.a.Oc(b);
            ...
            (function() {
                ...
                a.d.template = {
                    ...
                    update: function(b, c, d, e, f) {
                        ...
                        "foreach"in c ? e = a.ld(g || b, d && c.foreach || [], c, b, f) : d ? (f = "data"in c ? f.Zb(c.data, c.as) : f,
                ...
                a.a.Bb = function(e, f, g, h, l) {
                    ...
                    for (var D = [], p = [], w, C = 0, B, E; B = s[C]; C++)
                        ...
                        case "deleted":
                            ...
                            w.B && (w.B.k(),
                            w.B = n),
                            a.a.za(w.ca, e).length && (h.beforeRemove && (t.push(w),
                            z.push(w),
                            w.ja === d ? w = null : f[C] = w),
